...
<main class="resto-dashboard" style="padding: 20px;">
    ...
    <div class="resto-colonnes" style="display: flex; gap: 20px; margin-top: 20px;">
        ...
        <section class="resto-colonne" style="flex: 1; background: #f9f9f9; padding: 15px; border-radius: 8px;">
        ...
        <section class="resto-colonne" style="flex: 1; background: #f0f7ff; padding: 15px; border-radius: 8px;">
